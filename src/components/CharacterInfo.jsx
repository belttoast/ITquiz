...
import horsemenImg from '../assets/4-horse-men.jpg';
...
function CharacterInfo() {
  ...
  return (
    <div className="scroll-wrapper">
      ...
      {/* --- FAMILY SECTION (Scroll down content) --- */}
      <div className={`family-page ${character === 'yoru' ? 'yoru-mode' : ''}`}>
        <div className="family-image-wrapper">
          <img 
            src={character === 'asa' ? asaMomImg : horsemenImg} 
            alt={character === 'asa' ? "Asa's Mother" : "The 4 Horsemen"} 
        ...
        <div className="family-content-wrapper">
          {character === 'asa' ? (
            <div className="family-info-card">
              <h2 className="family-title">Family: Mother</h2>
              <div className="section-body">
            ...
            <div className="family-info-card yoru-card">
              <h2 className="family-title">Family: Sisters</h2>
              <div className="section-body">
      ...
      {/* Switch Button (Fixed to bottom of screen) */}
      <button className={`switch-btn ${character === 'yoru' ? 'yoru-btn' : ''}`} onClick={toggleCharacter}>
